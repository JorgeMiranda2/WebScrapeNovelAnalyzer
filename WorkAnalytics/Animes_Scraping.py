import json
from WorkUtils import convert_genres_to_list, conver_rating_to_float
...
# Resto de tu código
    ...
    def do_web_scraping(self, list_name):
        try: 
            ...
            "Rating":conver_rating_to_float(self.obtain_rating()),
            #"Languaje":self.obtain_languaje(),
            "Image":self.obtain_image(),
            #"Demography":self.obtain_demography(),
            "Genres":convert_genres_to_list(self.obtain_genres()),
